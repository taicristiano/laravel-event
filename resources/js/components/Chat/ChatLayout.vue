    ...
    <div>
        <div class="chat">
            ...
            <div class="message-box">
                <input type="text" v-model="message" v-on:keyup.enter="sendMessage" class="message-input" placeholder="Type message..."/>
    ...
    export default {
        ...
        methods: {
            loadMessage() {
                ...
                axios.get('messages')
                    .then(response => {
                        app.list_messages = response.data
                    })
                    .catch(error => {
                        console.log(error)
                    })
            ...
            sendMessage() {
                ...
                .then(response => {
                    app.list_messages.push({
                        message: app.message,
                        created_at: new Date().toJSON().replace(/T|Z/gi, ' '),
                        user: app.$root.currentUserLogin
                    })
                    app.message = ''
                })
                .catch(error => {
